			...
			<div class="row">
				...
				<div class="modal fade" id="Padja" tabindex="-1" role="dialog" aria-labelledby="Padja" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-body">
								<p class="card-text"> Etudiant en <b>Audiovisuel</b>, 							
								Graphic designer.........</p>
							</div>
							<div class="col-12 m-footer">
								<div class="heading-underline"></div>
									<a href="https://www.facebook.com/Mr-Padja-1841296376125779/" target="_blank"> <i class='fab fa-facebook-f' style='font-size:40px;color:#007dbb'></i></a>
									<a href="https://www.instagram.com/mrpadja/?hl=pt-br" target="_blank"><i class='fab fa-instagram' style='font-size:40px;color:black'></i></a>
								</div>
									<hr>
								<button type="button" class="btn btn-danger " data-dismiss="modal">Fermer</button>
							</div>							
